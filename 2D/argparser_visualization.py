...
import argparse
import settings_visualization as settings   # Use the custom settings.py file for default parameters
import os
...
# for visualization
parser.add_argument("--font_file", default=settings.FONT_FILE,
                    help="the path to the font file together with the font file name")
parser.add_argument("--font_size", default=settings.FONT_SIZE,
                    help="the font size")

parser.add_argument("--conv2d_color", default=settings.CONV2D_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--input_color", default=settings.INPUT_COLOR,
                    help="the color in the visualization graph")                    
parser.add_argument("--maxpooling2d_color", default=settings.MAXPOOLING2D_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--spatialdropout2d_color", default=settings.SPATIAL_DROPOUT2D_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--conv2dtranspose_color", default=settings.CONV2D_TRANSPOSE_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--concatenate_color", default=settings.CONCATENATE_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--zeropadding2d_color", default=settings.ZEROPADDING2D_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--dropout_color", default=settings.DROPOUT_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--dense_color", default=settings.DENSE_COLOR,
                    help="the color in the visualization graph")
parser.add_argument("--flatten_color", default=settings.FALTTEN_COLOR,
                    help="the color in the visualization graph")
